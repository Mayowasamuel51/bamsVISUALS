...
export const videos = [
    {
        id: 1,
        url: "https://vimeo.com/1085563688?share=copy",
        light: gallery_four,
        title: "Dami+Evodie (#LoveInGodsTime2025)",
        // subTitle: "THE STORY BETWEEN DAUGHTER AND MOM",
        // date: "30 FEBRUARY 2022",
        description: "Dami and Evodie’s journey is a reflection of love rooted in faith and guided by God’s perfect timing. As they prepare to say “I do” in May 2025, they invite you to celebrate a union built on purpose, prayer, and grace",
        description2: "Dami and Evodie’s journey is a reflection of love rooted in faith and guided by God’s perfect timing. As they prepare to say “I do” in May 2025, they invite you to celebrate a union built on purpose, prayer, and grace",
        // eventDetails: {
    ...
    {
        id: 2,
        url: "https://vimeo.com/1068223147?share=copy",
        light: gallery_three,
        title: "#OluwaTiSe – Seyi & Tiroye Traditional Wedding Teaser",
        subTitle: "THE STORY BETWEEN DAUGHTER AND MOM",
        date: "10 JULY 2022",
        description: "Seyi and Tiroye’s love story comes to life in this vibrant traditional wedding teaser — a joyful celebration of culture, connection, and answered prayers. Surrounded by family, colors, and rhythm, their union is a beautiful reminder that truly, Oluwa ti ṣe — God has done it.",
    ...
    },
    {
        ...
        light: gallery_one,
        title: "Laura & Edwin",
        // subTitle: "consectetur adipiscing elit. Ut elit tellus, luctus",
        // date: "23 FEBRUARY 2021",
        description: "Elegant, heartfelt, and full of joy — Laura and Edwin’s white wedding was a beautiful celebration of love and commitment. This teaser captures the tender moments, radiant smiles, and timeless beauty of a day they’ll never forget.",
        // description2: "Donec tincidunt erat a diam euismod pharetra. Vestibulum nec nisi eu mi viverra consequat nec non purus. Curabitur porta, felis at sollicitudin euismod, eros ipsum tincidunt massa, quis congue ipsum nisl ut risus. Praesent pharetra augue eget nibh fermentum, ut efficitur lectus posuere.",
        // eventDetails: {
        //     artists: ["Tyas Widagdo", "Elsa Verina", "Payad Smasi", "Berlin Sendum"],
        //     scriptedBy: "Hendrik Morella",
