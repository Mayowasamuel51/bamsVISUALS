...
const Navbar = () => {
  ...
  return (
    <header
      className={`bg-opacity-80 z-[999999999999999999999] w-full fixed top-0 left-0 right-0 flex justify-between items-center px-6 md:px-56 transition-all duration-500 ${
