...
const Contact = () => {
    ...
    return (
        <section className={`${pathname === "/contact" ? "bg-dark2" : "bg-[#949191]"} lg:p-32 md:p-10 p-4 py-20`}>
            <div className={`flex lg:flex-row  gap-20 ${pathname === "/contact" ? "lg:flex-row-reverse flex-col-reverse" : "flex-col-reverse"}`}>
                ...
                <div className="flex-1 flex flex-col gap-4">
                    ...
                    <h3 className={`font-bold font-cormorant text-[48px] ${pathname === "/contact" ? "text-white" : "text-black"}`}>REQUEST CALL BACK</h3>
