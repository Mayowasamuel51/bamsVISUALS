        ...
        <>
            <div className="text-center md:py-20 py-10 bg-dark space-y-10">
                <div>
                    ...
                    <motion.p variants={fadeIn("up", 0.4, 0.3)} initial="hidden" whileInView={"show"} viewport={{ once: true }} className="font-quicksand font-bold text-text_gold text-sm md:text-xl">BAM VISUALS, +234 811 823 6308 OR HELLO@BAMVISUALS.COM</motion.p>
                </div>
