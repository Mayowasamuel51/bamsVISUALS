    ...
    return (
        <>
            <div className="text-center md:py-20 py-10 bg-dark space-y-10">
                <div>
                    <h1 className="font-cormorant text-xl lg:text-3xl md:my-6 my-3 xl:w-[1000px] w-full mx-auto text-white">HAVE IDEA IN YOUR MIND ? LET&apos;S START YOUR PROJECT WITH US</h1>
                    <p className="font-quicksand font-bold text-text_gold text-base md:text-xl">BAM VISUALS, +234 811 823 6308 OR HELLO@BAMVISUALS.COM</p>
                </div>
