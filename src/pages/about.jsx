...
const containerVariant = {
    ...
    animate: {
        opacity: 1,
        transition: { duration: 0.4, delayChildren: 0.3, staggerChildren: 0.4, type: "spring" }
    }
};

const divChildVariant = {
    initial: { scale: 0, origin: "top" },
    animate: { scale: 1, origin: "top", transition: { duration: 0.4, type: "spring" } }
};
                ...
                >
                    <motion.div variants={divChildVariant} className="flex-1 flex flex-col gap-4">
                        ...
                        <p className="text-base md:text-lg font-light">
                            My style is a fusion of cinematic flair, documentary grit, and a deep love for the human 
                            experience. My films are woven with heart, soul, and a dash of magic. I chase light, laughter, 
                            and tears to craft stories that whisper secrets to your soul. With a keen eye for the authentic 
                            and the unscripted, I weave tales that transport you back to the moment it all happened. My films 
                            are a symphony of emotions, a dance between light and shadow, and a celebration of the beauty in 
                            the everyday. I don’t just capture moments—I bottle up the feelings, the joy, and the tears so 
                            you can relive them forever. Let’s create films that make your heart skip a beat and your soul 
                            feel alive.
                        </p>
