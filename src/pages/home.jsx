  ...
  return (
    <main className="">
        <div className="home min-h-screen flex justify-center items-center">
            <div className="relative z-10 text-white text-center flex flex-col gap-5">
                <h1 className="md:text-4xl text-2xl font-bold">Crafting cinematic tales that inspire </h1>
